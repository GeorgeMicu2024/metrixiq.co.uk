export const DIRECT_OPERATIONAL_SELECT =
  "driver_id,site,week_label,period_start,period_end,dcr,pod,cc,iadc,mentor_score,ementor,fico,concessions,raw_data,risk,issue,drivers(id,trid,full_name,site,status)";
