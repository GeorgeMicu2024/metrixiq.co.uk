...
export async function refreshWorkspacePerformance(supabase, organizationId) {
  const [{ data: scorecards, error: scorecardError }, metricRows, { data: siteScorecards, error: siteScorecardError }] = await Promise.all([
    supabase
  ...
  if (siteScorecardError) throw siteScorecardError;

  return {
    scorecards: scorecards || [],
    metricRows: metricRows || [],
    siteScorecards: siteScorecards || [],
  };
}
