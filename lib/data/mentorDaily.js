export const MENTOR_DAILY_SELECT =
  "id,driver_id,site,source_import_id,source_identity_key,report_date,week_label,mentor_score,raw_data,is_hidden,created_at,drivers(id,trid,full_name,site,status)";
