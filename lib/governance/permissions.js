export const PERMISSION_GROUPS = Object.freeze([
  {
    ...
    permissions: [
      ...
      ["view_integrations", "Integration Hub"],
      ["view_reliability", "Reliability Center"],
      ["view_portfolio", "Enterprise Portfolio"],
      ["view_enterprise_settings", "Enterprise Settings"],
      ["view_workflows", "Action Center & workflows"],
      ["view_developer_platform", "Integration & API Platform"],
    ],
  },
  {
    label: "Operations",
    permissions: [
      ...
      ["run_reliability_checks", "Run reliability checks"],
      ["manage_portfolio", "Manage enterprise portfolio"],
      ["manage_kpi_policy", "Manage KPI policies"],
      ["manage_branding", "Manage white-label branding"],
      ["manage_automations", "Manage automation rules"],
      ["manage_workflows", "Manage workflow playbooks"],
      ["approve_workflows", "Approve governed workflow actions"],
      ["manage_api_keys", "Manage developer API keys"],
      ["manage_webhooks", "Manage outgoing webhooks"],
      ["manage_delivery", "Manage external delivery connections"],
    ],
  },
  {
