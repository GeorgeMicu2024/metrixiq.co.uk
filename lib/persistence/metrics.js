...
export function metricRowFromDriver(
  ...
  const row = {
    ...
    week_label: period.granularity === "daily"\n      ? `${period.weekLabel || "W"}:${period.periodEnd}`\n      : (period.weekLabel || period.key),
    ...
    raw_data: {
      ...
      metric_granularity: period.granularity || "weekly",\n      calendar_week: period.weekLabel || null,\n      metric_date: period.granularity === "daily" ? (period.periodEnd || null) : null,\n      analysis_version: ANALYSIS_VERSION,
    },
  };
