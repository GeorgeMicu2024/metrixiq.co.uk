...
const NAV_PERMISSION = Object.freeze({
  ...
  "daily-dispatch": "view_driver_data",
  "pod": "view_driver_data",
  "dcr": "view_driver_data",
  "cc": "view_driver_data",
...
export function canAccessNav(id, access, platformAdmin, workspaceRole = "viewer", permissions = null) {
  ...
  if (id === "manager-chat" && !managers.includes(role)) return false;
