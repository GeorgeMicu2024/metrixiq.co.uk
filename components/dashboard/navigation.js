export const NAV_GROUPS = [
  ...
  { label: "OPERATIONS", items: [["site-operations", "Site Operations"], ["iadc", "IADC"], ["cdf", "CDF Feedback"], ["mentor", "Mentor"], ["concessions", "Concessions"], ["evidence", "Evidence & Incidents"], ["coaching", "Coaching"], ["notifications", "Notifications"], ["automation", "Automation Engine"]] },
...
export const NAV_ICONS = Object.freeze({
  ...
  "site-scorecards":"▤","driver-scorecards":"◫",drivers:"◎",performance:"↗",iadc:"✓",cdf:"◈",
